    ...
    <div class="container-fluid">
        ...
        <div class="col-md-8">
            <ul class="list-group" id="myinfo">
                <a href="#" onClick="window_print()" class="btn btn-info" style="margin-bottom:20px"><i
                        class="icon-print icon-large"></i> Print</a>
			...
			?>
                                <table class="table">
                                    <tr>
                                        ...
                                        <td> <input type="text" value="<?php echo $caseid?>" readonly="" name="caseid">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Name:</td>
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        $('#myinfo').append('<li class="list-group-item alert alert-danger"> ' +
                            response[0][i] + '</li>');
                    }
                } else {
